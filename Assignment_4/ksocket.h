...
// #define WINDOW_SIZE 40          // Sliding window size
// #define PORT_USER1 12345
// #define PORT_USER2 54321
// #define TIMEOUT 2               // Timeout period T in seconds
...
//     int prev_rwnd;            // Previous rwnd value for nospace handling
// } ReceiverWindow;
...
// typedef struct {
//     int shmid;
//     float drop_prob;          // Probability of message drop for testing
// } ThreadArgs;
...
typedef struct {
    ...
    int size;                 // Number of buffered messages
    int rwnd;                 // Receiver window size (available slots)
    int prev_rwnd;            // Previous rwnd for nospace handling
} ReceiverWindow;
...
typedef struct {
    int shmid;
    float drop_prob;          // Probability of message drop
} ThreadArgs;
